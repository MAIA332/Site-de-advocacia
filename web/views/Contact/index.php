...
<body>
    ...
    <div class="content-form">
        <div class="form">
            ...
            <form class="form-container" action="php/send.php" method="POST">
                ...
                <div class="form-item col">
                    <input class = "input" type="email" rows="8" required id="email" name="email" >
                    <label class="label" for="email">email</label>
                </div>
                <div class="form-item col">
                    <input class = "input" type="text" rows="8" required id="assunto" name="assunto" >
                <label class="label" for="assunto">assunto</label>
                </div>

                <div class="form-item">
                    <textarea class="textarea" rows="8" cols="38" name="mensagem" id="textarea" required></textarea>
                    <label class="label" for="textarea">mensagem</label>
                </div>
